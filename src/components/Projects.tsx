    ...
    <div>
      <div className="flex lg:flex-row flex-col justify-center items-center lg:space-x-20 space-x-0">
        ...
        <div className="flex flex-col justify-center items-start xl:w-[30%] lg:w-[40%] sm:w-[60%] es:w-[80%] w-[70%] space-y-2 lg:pt-0 pt-12">
          <h1 className="xl:text-[28px] lg:text-[28px] sm:text-[24px] text-[22px] font-semibold">
            {title}
          </h1>
          <p className="xl:text-[18px] lg:text-[18px] sm:text-[16px] text-[14px] text-justify">
            {description}
          </p>
          <div className="flex flex-row flex-wrap py-3">
            {topics.map((topic) => (
              <div
                className="flex justify-start items-center es:text-[14px] text-[12px] px-3 py-3 my-1 w-fit font-bold rounded-xl bg-white button-shadow
              mr-3 dark:bg-gray-700"
                key={topic}
              >
                {topic}
              </div>
      ...
      <div className="flex w-full">
        <div className="flex sm:py-10 py-5 w-full flex-col">
          <div className="flex flex-row justify-center">
            <h1 className="font-semibold lg:text-[56px] md:text-[48px] sm:text-[42px] text-[32px] pb-8">
              Projects
            </h1>
          </div>
