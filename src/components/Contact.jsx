      ...
      <div className='flex w-full'>
        <div className='flex py-10 justify-center w-full flex-col'>
          <div className='flex flex-row justify-center'>
            <h1 className='font-semibold lg:text-[56px] md:text-[48px] sm:text-[42px] text-[32px]'>Contact</h1>
          </div>
          <div className='flex pt-20 lg:flex-row flex-col items-center'>
            ...
            <motion.button 
              className='flex justify-start items-center px-10 py-5 my-5 space-x-2 w-fit font-semibold bg-white 
